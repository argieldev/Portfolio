...
function Footer() {
  return (
    <>
      <footer className="flex flex-col py-6" id="contact">
              ...
              <ul className="grid grid-cols-1 gap-3 sm:flex">
                ...
                <li>
                  <a className="flex items-center px-4 py-2 gap-2 border border-border rounded-md transition-colors duration-50 ease-in cursor-pointer hover:bg-surface-hover">
                    ...
                    <span className="text-sm sm:text-md">LinkedIn</span>
                  </a>
                </li>
              </ul>
            </motion.nav>
        ...
        <div className="flex items-center justify-between pt-6 mx-6 border-t border-border">
          <p className="text-sm text-text-muted font-ibm-plex-mono">
            &copy; {new Date().getFullYear()} Argiel Ducut
          </p>
          <p className="text-sm text-text-muted font-ibm-plex-mono">
            Built with React
          </p>
