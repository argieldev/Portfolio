        ...
        <div className="flex flex-col gap-12 sm:flex-row">
          <div className="flex flex-col gap-4">
            ...
            <ul className="flex gap-4">
              <li>
                <a
                  className="flex items-center px-4 py-2 gap-1 text-sm text-bg bg-primary border rounded-md transition-colors duration-50 ease-in cursor-pointer hover:bg-primary-hover sm:text-md"
                  href="#projects"
                >
                  View Work{" "}
                  <svg
              ...
              <>
                <a className="text-sm px-4 py-2 border border-border rounded-md transition-colors duration-50 ease-in cursor-pointer hover:border-text-primary sm:textmd" href="#contact">
                  Get in Touch
                </a>
              </>
            </ul>
